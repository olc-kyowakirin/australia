$(function () {
    ...
    * ======================================== */
    (function ($) {
        ...
        var modalContentTmp = {
            type01: '<div class="box-text"><p>You will be accessing an external site.</p><p>Click "OK" to continue.</p></div><div class="align-c"><a href="{{href}}" target="_blank" class="btn-03 btn-small">OK<img src="/australia/share/images/icon_link_blank_04.png" alt="Open in new window" class="icon-blank"></a></div>',
            ...
            //my
                        type09: '<div class="box-offices-globalarea"><div class="box-offices-globalarea-outer"><div class="box-inner"><div class="box-panel"><!--Malaysia --><div class="panel"><div class="box-thumb"><a href="https://www.kyowakirin.com/malaysia/index.html" target="_blank" class="outBoundModalLink"><img src="images/index_img_regionalnetwork_panel_malaysia_01.jpg" alt=""></a></div><div class="box-content"><h3 class="title"><span class="sub">MALAYSIA</span>Kyowa Kirin Malaysia Sdn Bhd<br><span class="text-italic"><small>(formerly known as Kyowa Hakko Kirin (Malaysia) Sdn Bhd)</small></span></h3><p class="box-text">A501 West Wing<br>Wisma Consplant 2<br>Jalan SS 16/1, Subang Jaya<br>47500 Selangor, Malaysia<br/>E-mail:<a href="mailto:enquiry.kkmy@kyowakirin.com" target="_blank">&nbsp;enquiry.kkmy@kyowakirin.com</a></p><p class="link-icon link-text"><a href="https://www.kyowakirin.com/malaysia/index.html" target="_blank" class="outBoundModalLink"><span>Visit website</span></a></p></div><!-- /.panel Malaysia --></div><!-- /.box-panel --></div><!-- /.box-inner --></div><!-- /.box-offices-globalarea-outer --></div>',
            //th
