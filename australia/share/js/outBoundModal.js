$(function () {
    ...
    * ======================================== */
    (function ($) {
        ...
        var modalContentTmp = {
            type01: '<div class="box-text text-center"><p>You will be accessing an external site. The information you are about to be referred to may not comply with Australian regulatory requirements. Further information relevant to the Australian environment is available from the Company or via the Product Information.</p><p>Click "OK" to continue.</p></div><div class="align-c"><a href="{{href}}" target="_blank" class="btn-03 btn-small">OK<img src="/australia/share/images/icon_link_blank_04.png" alt="Open in new window" class="icon-blank"></a></div>',
            ...
            //my
                        type09: '<div class="box-offices-globalarea"><div class="box-offices-globalarea-outer"><div class="box-inner"><div class="box-panel"><!--Malaysia --><a href="https://www.kyowakirin.com/malaysia/index.html" target="_blank" class="panel outBoundModalLink"><div class="box-thumb"><img src="images/index_img_regionalnetwork_panel_malaysia_01.jpg" alt=""></div><div class="box-content"><h3 class="title"><span class="sub">MALAYSIA</span>Kyowa Kirin Malaysia Sdn Bhd<br><span class="text-italic"><small>(formerly known as Kyowa Hakko Kirin (Malaysia) Sdn Bhd)</small></span></h3><p class="box-text">A501 West Wing<br>Wisma Consplant 2<br>Jalan SS 16/1, Subang Jaya<br>47500 Selangor, Malaysia</p><p class="link-icon link-text"><span>Visit website</span></p></div><!-- /.panel Malaysia --></a><!-- /.box-panel --></div><!-- /.box-inner --></div><!-- /.box-offices-globalarea-outer --></div>',
            //th
